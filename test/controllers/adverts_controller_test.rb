...
class AdvertsControllerTest < ActionController::TestCase
  ...
  test "should create advert" do
    assert_difference('Advert.count') do
      post :create, advert: { email: @advert.email, name: @advert.name, surname: @advert.surname, title: @advert.title }
    end
  ...
  test "should update advert" do
    patch :update, id: @advert, advert: { email: @advert.email, name: @advert.name, surname: @advert.surname, title: @advert.title }
    assert_redirected_to advert_path(assigns(:advert))
  end
